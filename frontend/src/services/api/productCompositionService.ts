...
export const productCompositionService = {
  ...
  async updateRawMaterialQuantity(productId: number, rawMaterialId: number, composition: CompositionDTO): Promise<CompositionDTO> {
    return apiClient.put<CompositionDTO>(`/products/${productId}/raw-materials/${rawMaterialId}`, composition);
  },
